...
image_path = "C:\\Users\\Deepak\\Desktop\\college_project\\Farm-Management.png"  # Replace with your image path

# Convert the image to a base64 string
base64_image = get_base64_of_image(image_path)

# Define the background image style using the base64 string
page_bg_img = f"""
<style>
